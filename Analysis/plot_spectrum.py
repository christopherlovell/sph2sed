...
print intrinsic['SED'].shape

plt.semilogx(intrinsic['Wavelength'], np.log10(intrinsic['SED'][z,a]), markersize=40, color='grey', label='intrinsic')
plt.semilogx(cloudy['Wavelength'], np.log10(cloudy['SED'][z,a]), label='Cloudy')
