...
class sed:
    ...
    def load_intrinsic(self, name='fsps'):

        print("Loading SPS model from pickle...")

        temp = pcl.load(open('%s/intrinsic/output/%s.p'%(self.package_directory,name), 'rb'))
    ...
    def calculate_sed(self, sed, Z, a, p_metal, p_age, p_imass):
        """
